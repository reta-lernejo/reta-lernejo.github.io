...
this.doAddHydrogens = (this.jbr != null && !this.isTrajectory && !this.isPyMOLsession && !this.ms.getMSInfoB ("pdbNoHydrogens") && (this.ms.getMSInfoB ("pdbAddHydrogens") || this.vwr.getBoolean (603979894)));
if (info != null) {
...
this.doMinimize = (this.is2D || this.ms.getMSInfoB ("minimize3D")) && this.ms.getMSInfoB ("doMinimize");
...
var nAtoms = adapter.getAtomCount (asc);
...
this.model.bsAtoms.set (this.ms.ac + nAtoms);
...
var atom = this.addAtom (isPdbThisModel, iterAtom.getSymmetry (), iterAtom.getAtomSite (), isotope, name, charge, iterAtom.getPartialCharge (), iterAtom.getTensors (), iterAtom.getOccupancy (), iterAtom.getBfactor (), iterAtom.getXYZ (), iterAtom.getIsHetero (), iterAtom.getSerial (), iterAtom.getSeqID (), group3, iterAtom.getVib (), iterAtom.getAltLoc (), iterAtom.getRadius (), iterAtom.getBondRadius ());
